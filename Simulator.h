...
public:
    ...
    Simulator(const vector<Actor> actors, const vector<Resource> resources, const function<function_space(function_space)> utility_function, const function_space peak, const function_space epsilon = 0, const bool isolation_optimal = false, const bool impact_aware = false);
} Simulator;
