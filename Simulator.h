...
private:
    ...
    function_space get_cur_util_for_actor(Actor& a, const bool measure_segregation=false);
...
public:
    ...
    Simulator(vector<Actor> actors, vector<Resource> resources, function<function_space(function_space)> utility_function, const bool isolation_optimal = false, const bool impact_aware = false);
} Simulator;
